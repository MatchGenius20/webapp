 ...
 export const coaches: Coach[] = [
    {
      ...
      calendar: [
        { session: 'Session 1', date: '22 July 2024', start: '10:00', end: '11:00' },
        { session: 'Session 2', date: '23 July 2024', start: '11:00', end: '12:00' },
        { session: 'Session 3', date: '24 July 2024', start: '12:00', end: '13:00' }
      ]
    },
    {
        id: '2',
        ...
        image: '/images/user.png',
        experience: 15,
        description: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime rem corporis esse asperiores eum in? Tempore enim odit reiciendis debitis eum voluptatem a quasi, aperiam magnam repellat sed modi amet mollitia, itaque assumenda! Iusto!",
        statistics: {
          totalSessions: 45,
          totalDuration: 230
        },
