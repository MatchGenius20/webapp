...
const SidebarCoach: React.FC<SidebarProps> = ({ selected }) => {
    ...
    <>
      ...
      >
        ...
        <ul className="pt-16 sm:pt-20 space-y-2 sm:space-y-4">
          <li>
            <Link
              href="/coach-dashboard/profilesettings"
          ...
          <li>
            <Link
              href="/coach-dashboard/payments&wallets"
          ...
          <li>
            <Link
              href="/coach-dashboard/scheduleSession"
