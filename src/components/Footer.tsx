    ...
    <footer className="bg-[#EBEFF8] text-gray-700 py-8 px-4 sm:px-6 lg:px-8">
      <div className="container mx-auto flex flex-col lg:flex-row justify-between items-start space-y-8 lg:space-y-0">
        <div className="flex flex-col items-start max-w-xs lg:max-w-sm">
          <h2 className="text-[#453FE1] text-md md:text-xl lg:text-2xl font-bold">DebatesMatch</h2>
          <p className="text-sm md:text-md lg:text-lg text-[#A2A2A2] py-2">
            Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit.
          </p>
          <div className="flex space-x-4 mt-4">
            <Link href="https://www.linkedin.com" aria-label="LinkedIn">
              <img src="/images/linkedin 1.png" alt="LinkedIn" className="w-5 h-5 md:w-6 md:h-6" />
            </Link>
            <Link href="https://twitter.com" aria-label="Twitter">
              <img src="/images/twitter.png" alt="Twitter" className="w-5 h-5 md:w-6 md:h-6" />
            </Link>
            <Link href="https://www.instagram.com" aria-label="Instagram">
              <img src="/images/instagram 1.png" alt="Instagram" className="w-5 h-5 md:w-6 md:h-6" />
            </Link>
            <Link href="mailto:info@example.com" aria-label="Email">
              <img src="/images/mail 1.png" alt="Email" className="w-5 h-5 md:w-6 md:h-6" />
            </Link>
          </div>
        </div>
        <div className="flex flex-col md:flex-row md:space-x-8 space-y-4 md:space-y-0">
          <div>
            <h3 className="text-[#8480F6] font-bold text-lg md:text-xl">Links</h3>
          ...
          <div>
            <h3 className="text-[#8480F6] font-bold text-lg md:text-xl">Community</h3>
            <ul className="space-y-1 text-sm md:text-md text-[#A2A2A2]">
              <li>
                <Link href="/" passHref>
                  <span className="hover:underline cursor-pointer">Home</span>
          ...
          <div>
            <h3 className="text-[#8480F6] font-bold text-lg md:text-xl">Resources</h3>
            <ul className="space-y-1 text-sm md:text-md text-[#A2A2A2]">
              <li>
                <Link href="/" passHref>
                  <span className="hover:underline cursor-pointer">Home</span>
