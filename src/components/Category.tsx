...
const CategoryPage: React.FC = () => {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 my-5">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
        <div className="flex flex-col">
          <h2 className="text-4xl font-bold text-[#202020] mb-2">
            Explore coaches by category
          </h2>
          <p className="text-lg text-[#000000]">
            Browse top-rated coaches by browsing our categories, which will make
            it easier for you.
          </p>
        </div>
