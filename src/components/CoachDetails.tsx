...
import DefautCoachPic from '../../public/images/coach 1.png'
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md border border-[#D0D0D0]">
      <div className="flex items-center mb-4">
        <div className="w-16 h-16 rounded-full border border-primary mr-4 flex items-center justify-center p-1">
          <Image
            src={coach.image || DefautCoachPic}
            alt={coach.name || ''}
      ...
      <p className="mb-6 text-[#8D8D8B] text-sm whitespace-pre-line">
        {coach.timings ?? '---'}
      </p>
